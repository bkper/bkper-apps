...
export const APP_LOGO_URL_DARK =
    'https://storage.googleapis.com/bkper-public/logos/agents/exchange-agent-dark.svg';

export const APP_WEBSITE_URL = 'https://bkper.com/apps/exchange-bot';
export const APP_REPOSITORY_URL = 'https://github.com/bkper/bkper-apps/tree/main/exchange-bot';
