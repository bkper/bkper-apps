...
- Add an explicit Full Reset confirmation dialog as the final implementation subchunk of Chunk 15, after the operation workflows are wired and before final browser acceptance.
