...
**Chunks 1–23 complete — Chunk 24 repository consolidation has not started.**
...
Cloudflare is production-authoritative for events and the Portfolio Bot menu. The unchanged Google Apps Script web app remains available for immediate menu rollback, and the unchanged Google Cloud Function remains available for immediate event rollback.
