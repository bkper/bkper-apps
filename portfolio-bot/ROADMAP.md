...
**Chunks 1–22 complete — Chunk 23 production menu cutover is next.**
...
Cloudflare is production-authoritative for events. The Google Apps Script web app remains production-authoritative for the Portfolio Bot menu, and the unchanged Google Cloud Function remains available for immediate event rollback.
