...
- Wired Full Reset through the shared Realized Results operation lifecycle and authenticated generated API client, rendered it only when available and to the left of regular Reset as a danger action, and retained its owner and open and unlocked Collection availability boundary.
