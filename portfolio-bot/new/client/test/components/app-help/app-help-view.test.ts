...
describe('App help view', () => {
    it('opens the app and repository help links in a new tab', () => {
        ...
        view.app = new App({
            website: 'https://example.com/global-portfolio-bot',
            repoUrl: 'https://github.com/example/global-portfolio-bot',
        });
        ...
        expect(openedUrls).toEqual([
            'https://example.com/global-portfolio-bot',
            'https://github.com/example/global-portfolio-bot',
        ]);
