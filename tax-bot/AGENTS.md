...
- `new/` — isolated Cloudflare Worker migration target with event ingress, guards, tax source discovery, calculation, Transaction construction, and posted/restored batch creation ported; deletion and update mutation behavior remains to be ported.
