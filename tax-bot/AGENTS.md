...
- `new/` — isolated Cloudflare Worker migration target with subscribed event behavior ported and the full deterministic parity and drift audit complete; preview readiness and canary work remain.
