...
This is the event-only Cloudflare Worker migration target. The active GCP implementation remains in `../legacy/` until the separately approved production webhook cutover.
